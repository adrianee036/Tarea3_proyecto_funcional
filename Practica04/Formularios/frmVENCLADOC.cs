...
{
    public partial class frmVENCLADOC : Form
    {
        ...
        private void frmVENCLADOC_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;     // puedo presionar la tecla escape
            this.Text = HMenu.cia + "   Consulta Clase de Documento";

            this.dgv.EnableHeadersVisualStyles = false;
            this.dgv.ColumnHeadersVisible = true;
            this.dgv.RowHeadersVisible = false;

            this.dgv.Columns.Add("Col00", "ID Clase");
        ...
        private void frmVENCLADOC_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BuscarDatos()
        {
            ...
            SqlCommand sqCmd = new SqlCommand("SELECT Clase, Descripcion"
                                              + "  FROM Clase_Doc "
            ...
            try
            {
                ...
                {  // no es fin de archivo true false
                    ...
                    dgv[0, xRows].Value = Convert.ToString(recordset["Clase"]);     // escribe en la grilla, en la celda 0 y en la fila (x), el contenido del campo IDDEPARTAMENTO     de la tabla DEPARTAMENTO
